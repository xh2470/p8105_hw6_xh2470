...
```
    ...
    ##    <chr>            <dbl>     <dbl> <dbl>
    ##  1 0001              7.33      1.03  2.02
    ##  2 0002              7.29      1.03  2.01
    ##  3 0003              7.20      1.04  2.01
    ##  4 0004              7.17      1.03  2.00
    ##  5 0005              6.98      1.04  1.98
    ##  6 0006              7.14      1.03  1.99
    ##  7 0007              7.16      1.04  2.01
    ##  8 0008              7.26      1.05  2.03
    ##  9 0009              7.01      1.05  2.00
    ## 10 0010              7.36      1.03  2.03
    ## # ... with 4,990 more rows
...
limit of 95% confidence interval for log(beta0 \* beta1) is **1.97** and
**2.06**, respectively.
