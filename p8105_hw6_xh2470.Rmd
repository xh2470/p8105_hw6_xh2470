...
birthweight_df =
  ...
  mutate(
   ...
   mutate(
    ...
    mod_2  = map(train, ~lm(birthweight ~ head_circ * sex + length * sex + head_circ * sex + head_circ * sex *length, data = .x)),
...
The lower limit and upper limit of 95% confidence interval for r square is **`r round(pull(r_square_ci, ci_lower),digit = 3)`** and **`r round(pull(r_square_ci, ci_upper), digit = 3)`**, respectively. The lower limit and upper limit of 95% confidence interval for log(beta0 * beta1) is **`r round(pull(intercept_ci, ci_lower),digit = 3)`** and **`r round(pull(intercept_ci, ci_upper),digit = 3)`**, respectively. 
